...
//
// ScrollArea — a custom-styled scrollable container.
// Browser default scrollbars look different on every OS (and ugly on
// Windows). ScrollArea renders a consistent, themeable scrollbar.
//
// USAGE (Phase 5f-2 sidebar):
//   <ScrollArea className="h-[calc(100vh-4rem)]">
//     {/* sidebar content — scrolls if content > viewport height */}
//   </ScrollArea>
