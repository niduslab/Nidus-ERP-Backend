...
//
// Tooltip primitive — small floating label on hover/focus.
// Used in Phase 5f-2 for showing labels on collapsed sidebar icons.
//
// USAGE:
//   <TooltipProvider>
//     <Tooltip>
//       <TooltipTrigger asChild><Button>Hover me</Button></TooltipTrigger>
//       <TooltipContent>This is the tooltip text</TooltipContent>
//     </Tooltip>
//   </TooltipProvider>
//
// TooltipProvider must wrap the app once (we'll add it in main.tsx in 5f-3).
