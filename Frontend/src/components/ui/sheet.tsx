...
//
// The Sheet primitive — a side-drawer that slides in from an edge.
// Built on Radix Dialog (same accessibility guarantees: focus trap,
...
//
// SIDES:
//   left | right | top | bottom — controls which edge it slides in from.
...
// ── Overlay = dim background behind the sheet ──
...
// ── Variants for the four sides ──
// cva generates the right Tailwind classes based on the `side` prop.
...
// ── Sub-components for layout inside the sheet ──
